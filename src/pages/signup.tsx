  ...
  return (
    <div className=' border rounded-[30px] border-[#6c9df3] h-[400px] w-72 grid content-center'>
        <form className='text-white  grid justify-items-center  '>
            ...
            <input className='placeholder-[#acacac] focus:outline-none text-white px-[80px] py-[10px] w-[200px] bg-transparent border rounded-[30px] border-[#6c9df3] my-2 p-[px]' type="email" placeholder='Email'/>
